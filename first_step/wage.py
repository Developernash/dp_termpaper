...
DATA_DIR    = "C:\\Users\\Nashw\\Studiet\\polit\\2. Semester\\DynamicProgramming\\Thesis\\dp_termpaper\\data"
...
# save as txt file
np.savetxt(os.path.join(out, "wage_params_udd1.txt"), [beta0_1, beta1_1, beta2_1])
...
# save as txt file
np.savetxt(os.path.join(out, "wage_params_udd2.txt"), [beta0_2, beta1_2, beta2_2])

df_edu_2["predicted"]=np.exp(beta0_2 + beta1_2*df_edu_2["age"] + beta2_2*df_edu_2["age"]**2)
...
# save as txt file
np.savetxt(os.path.join(out, "wage_params_udd3.txt"), [beta0_3, beta1_3, beta2_3])

df_edu_3["predicted"]=np.exp(beta0_3 + beta1_3*df_edu_3["age"] + beta2_3*df_edu_3["age"]**2)
